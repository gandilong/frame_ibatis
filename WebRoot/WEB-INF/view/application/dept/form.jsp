...
<div class="row-fluid">
        <div class="span12">    
           <form id="fm" class="form-horizontal" action="system/user/formSave" method="post">
               <fieldset>
                   <legend class="text-info" style="font-size:16px;font-weight: bolder">部门表单</legend>
                   <input type="hidden" id="id" name="id" value="${values.id}">
		           <div class="control-group">
		               <div class="controls">
		                     <label class="control-label" for="title">部门名称：</label>
		                     <input placeholder="请输入部门名称" class="input-xlarge" type="text" id="title" name="title" value="${values.title}" />
		               </div>
		           </div>
		
		          <div class="control-group">
		                <div class="controls">
		                    <label class="control-label" for="code">部门代码：</label>
		                    <input placeholder="请输入部门代码" class="input-xlarge" type="text" id="code" name="code" value="${values.code}"/>
		                </div>
		          </div>
		          <div class="control-group">
		            <div class="controls input-append">
		                <label class="control-label" for="person">部门主管：</label>
		          ...
		          <div class="control-group">
		            <div class="controls input-append">
		                <label class="control-label" for="operson">部门助理：</label>
		                <input placeholder="请选择" class="input-xlarge" type="text" id="operson" name="operson" value="${values.operson}" />
		                <button class="btn" type="button" onclick="selection()"><span class="icon-user" id="personSelect"></span></button>
		            </div>
		          ...
		          <div class="control-group">
		                <div class="controls">
		                    <label class="control-label" for="code">部门电话：</label>
		                    <input placeholder="请输入部门电话" class="input-xlarge" type="text" id="code" name="code" value="${values.code}"/>
		                </div>
		          </div>
		          <div class="control-group">
		            <div class="controls">
