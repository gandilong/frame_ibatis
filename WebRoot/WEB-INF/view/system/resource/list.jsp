...
$(function(){
			$('#grid').datagrid({
			    ...
			    columns:[[
			              ...
			              {field:'name',title:'标记',width:270,sortable:true,editor:{type:'text',options:{required:true}}},
			              {field:'title',title:'名称',width:180,sortable:false,editor:{type:'text',options:{required:true}}}
			              ]],
		    ...
		    $('#toInsert,#toDelete,#toBack,#toSave').click(function(){
         ...
         function toDelete(){
             ...
             $.ajax({
                   type: "POST",
                   url: "system/resource/formDelete",
                   data: "id="+row.id,
                   success: function(msg){
                      if('0'==msg){
