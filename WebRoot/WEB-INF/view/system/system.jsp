...
<html>
    ...
    <body id="system" class="easyui-layout">
         <!-- 顶部模块 -->
         <div data-options="region:'north',border:false,fit:false,minHeight:60,maxHeight:60,href:'header?model=system'" style="height:60px;overflow-y:hidden;background:url('${ctx}/tools/easyui/themes/header_bg_highlight.png') repeat-x;padding:10px"></div>
